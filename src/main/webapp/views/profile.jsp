...
<body>
    ...
    <!-- Tag Profile -->
    <form action="/WebMovie/page/profile" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6"><label class="labels">Mật khẩu</label><input type="text" name="matKhau"
